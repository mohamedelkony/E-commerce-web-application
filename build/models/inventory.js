...
class InventoryModel {
    ...
    async getProducts(limit) {
        ...
        if (limit == undefined || limit == null)
            thisLimit = 10;
        const [res, fields] = await this.conn.execute("select a.id as product_id,a.product_name,a.price,a.product_desc,a.quantity,b.url as image_url,b.image_name from inventory as a left join products_images as b on a.id=b.its_product_id order by a.price desc limit ?;", [thisLimit.toString()]);
        return res;
    }
